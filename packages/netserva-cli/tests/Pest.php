...
function createTestVhostConfiguration(array $attributes = []): \NetServa\Cli\Models\VhostConfiguration
{
    return \NetServa\Cli\Models\VhostConfiguration::factory()->create(array_merge([
...
function createTestMigrationJob(array $attributes = []): \NetServa\Cli\Models\MigrationJob
{
    return \NetServa\Cli\Models\MigrationJob::factory()->create(array_merge([
...
function createTestSetupJob(array $attributes = []): \NetServa\Cli\Models\SetupJob
{
    return \NetServa\Cli\Models\SetupJob::factory()->create(array_merge([
        'name' => 'test-setup',
        'status' => 'pending',
